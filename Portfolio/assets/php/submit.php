...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['comment'])){
	...
	$mail->Username="mochpxt@gmail.com";  // Your Mail
	$mail->Password="Mochpxt##98"; // Your app password

	$mail->setFrom($email, $name);  
	$mail->addAddress("mochpxt@gmail.com", "Kamohelo Bore"); // (Your Mail) An email address that will receive the email with the output of the form
